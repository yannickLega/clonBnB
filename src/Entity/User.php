...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(allowEmptyString=false, min=10, minMessage="Votre introduction ne peut faire moins de 10 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(allowEmptyString=false, min=100, minMessage="Votre description doit comporter au moins 100 caractères")
     */
    private $description;
